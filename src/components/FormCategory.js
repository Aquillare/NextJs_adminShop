...
export default function FormCategory({ setAlert, setOpen, category }) {
  ...
  const handleSubmit = (event) => {
    ...
    /**
     * En esta validacion , si category no existe, entonces agregamos con la data
     * un nuevo categoryo a la Api, si category existe, entonces vamos a actualizar
