...
export default function FormProduct({ setAlert, setOpen, product }) {
  ...
  const handleSubmit = (event) => {
    ...
    /**
     * En esta validacion , si product no existe, entonces agregamos con la data
     * un nuevo producto a la Api, si product existe, entonces vamos a actualizar
          ...
          <div className="grid grid-cols-6 gap-6">
            ...
            <div className="col-span-6">
              ...
              <select
                id="categoryId"
                name="categoryId"
                defaultValue={product?.categoryId?.id}
